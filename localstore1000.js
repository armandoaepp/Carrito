	...
	function List(){
		...
		for(var i in tbClients){
			var cli = JSON.parse(tbClients[i]);
		  	datos +="<tr>";
			datos += "	<td><img src='edit.png' alt='Edit"+i+"' class='btnEdit'  onClick='mEditar("+cli.ID+");'/>";
			datos += " <img src='delete.png' alt='Delete"+i+"' class='btnDelete' onClick='Delete("+cli.ID+");'/></td>" ;
			datos += "	<td>"+cli.ID+"</td>" ;
